...
from moveit_msgs.msg import MoveGroupAction, MoveGroupGoal, Constraints, JointConstraint, PositionConstraint, OrientationConstraint, BoundingVolume
from tf.listener import TransformListener
from shape_msgs.msg import SolidPrimitive
from applevision_rospkg.srv import MoveGroup, MoveGroupResponse
import actionlib
import rospy
...
class MoveGroupInterface(object):
    ...
    def __init__(self, group=GROUP_NAME, frame=WORLD_FRAME, listener=None, plan_only=False, move_group='move_group'):
        ...
        print("here")
        # IT GETS STUCK HERE,, WHAT IS MOVE_GROUP?
...
if __name__ == "__main__":
    ...
    bot = MoveGroupInterface()
    s = rospy.Service('move_group', MoveGroup, bot.moveToJointPosition)